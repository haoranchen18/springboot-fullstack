package com.haoran.demo.integration;

import com.fasterxml.jackson.core.type.TypeReference;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.github.javafaker.Faker;
import com.haoran.demo.student.Gender;
import com.haoran.demo.student.Student;
import com.haoran.demo.student.StudentController;
import com.haoran.demo.student.StudentRepository;
...
public class StudentIT {
    ...
    void canRegisterNewStudent() throws Exception{
        // given
        // use faker to produce fake random names and emails
    ...
    void canDeleteStudent() throws Exception {
        ...
        String email = String.format("%s@google.edu",
                StringUtils.trimAllWhitespace(name.trim().toLowerCase()));
